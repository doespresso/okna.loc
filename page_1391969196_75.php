        ...
        <ul class="nav navbar-nav navbar-right">
          <li>
            <div class="navbar-phone">
              <tel>+7 495 778 77 88</tel>
            </div>
          </li>
          <li>
<div class="btn-group">
<button href="#menu" type="button" class="btn btn-default navbar-btn">перезвонить</button>
<button href="#menu" type="button" class="btn btn-default navbar-btn">рассчитать</button>
</div>
          </li>
        </ul>
...
<?php include_once SB_CMS_PL_PATH.'/pl_menu/prog/pl_menu.php';
        ...
        <div class="col-md-2 col-sm-4">
<ul>
<li class="nav-title">К оплате принимаются</li>
<li><img src="http://<?php echo $_SERVER['SERVER_NAME']?>/assets/picto/ccards/card_logos.svg" height="20" alt="Nice green circle"/></li>
</ul>
        </div>
      </div>
<div class="row">
<div class="col-md-4 col-md-offset-3"><p class="small">&copy; Все права защищены 2011-2014<br/>Названия торговых марок REHAU, Veka, Visa, MasterCard, Maestro и другие являются собственностью правообладателей.</p></div>
<div class="col-md-3"><p class="small">Условия опубликованные на Интернет-сайте не являются публичной офертой</p></div>
</div>
    </div>
  </div>
</footer>
