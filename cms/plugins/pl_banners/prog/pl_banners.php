...
//		достаем макеты дизайна списка и элемента
		//$res = sql_param_assoc('SELECT sbtl.sbdl_element, sbtl.sbdl_checked, sbtl.sbdl_elem_temps, sbtl.sbdl_count, sbtl.sbdl_top, sbtl.sbdl_bottom, sbt.sbt_lang, sbt.sbt_element, sbt.sbt_fields_temps
        //                        FROM sb_banners_temps_list sbtl, sb_banners_temps sbt
        //                        WHERE sbdl_id=?d AND sbt.sbt_id=sbtl.sbdl_elem_temps', $temp_id);
